...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='models/baseline WITHOUT PRETRAIN',
...
class Res18Feature(nn.Module):
    def __init__(self, pretrained=False, num_classes=7, drop_rate=0):  # 改了 为0
