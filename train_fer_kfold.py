...
def parse_args():
    ...
    parser.add_argument('--raf_path', type=str, default='D:\\Facial Expression Recognition\\表情识别数据集\\CK+48',
                        help='Raf-DB dataset path.')
    # parser.add_argument('--raf_path', type=str,
    #                     default='D:\\Facial Expression Recognition\\表情识别数据集\\Oulu_CASIA_NIR_VIS\\NI\\Strong',
    #                                                             help ='Raf-DB dataset path.')
    parser.add_argument('--checkpoint', type=str, default='new2_model/CK+',
